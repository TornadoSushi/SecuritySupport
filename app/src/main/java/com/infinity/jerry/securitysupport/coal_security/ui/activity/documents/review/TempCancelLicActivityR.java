...
public class TempCancelLicActivityR extends BaseActivity {
    ...
    public void initData() {
        ...
        record = DataSupport.where("planId = ? AND type = 1 AND subItemId = ?", String.valueOf(planId), String.valueOf(subItemId)).findLast(TempCancelLic.class);
    ...
    public void initView() {
        ...
        titleBar.getImBack().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ZDialogUtils.showDialog(TempCancelLicActivityR.this, "您还未保存修改，如需保存，请点击右上'完成'", new CallBack0() {
                    @Override
        ...
        titleBar.setOnTextModeListener(new ZTitleBar.OnTextModeListener() {
            ...
            public void onClickTextMode() {
                save();
                Toasty.success(TempCancelLicActivityR.this, "完成").show();
            }
        });
    ...
    private void save() {
        ...
        if (record == null) {
            ...
            plan.setDocName("暂扣或者吊销煤炭生产许可证决定书");
            plan.setDocType(DocsConstant.TEMP_CANCEL_LIC);
